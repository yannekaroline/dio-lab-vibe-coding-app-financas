...
## Assistente Financeiro Simplificado e Universal (Vibe Coding)

## Sobre o Projeto
Este projeto foi desenvolvido como parte do desafio **Vibe Coding** da Digital Innovation One (DIO).

O objetivo é criar o **conceito de um aplicativo de organização de finanças pessoais com Inteligência Artificial**, utilizando o jeito Vibe de programar: guiando a IA por meio de prompts claros, humanos e bem estruturados, sem a necessidade de escrever código.

O aplicativo foi pensado como um **assistente financeiro conversacional**, acessível e acolhedor, focado em ajudar pessoas a entenderem e organizarem seu dinheiro de forma simples e prática.
...
## Solução Proposta
O aplicativo funciona como um **Assistente Financeiro Simplificado**, que traduz números em frases simples e responde, de forma direta, três perguntas essenciais do dia a dia:

- Quanto dinheiro eu tenho agora?
- Até quando esse dinheiro precisa durar?
- Quanto posso gastar por dia sem faltar?

Tudo isso por meio de uma interface acessível, linguagem humana e poucas ações, priorizando a experiência do usuário.
...
Criar um aplicativo de assistência financeira simples, acessível e humano, que ajude pessoas leigas, idosas ou com deficiência a entender e organizar seu dinheiro no dia a dia, sem exigir conhecimento financeiro ou tecnológico.

O aplicativo deve funcionar como um assistente, não como uma ferramenta técnica de controle financeiro.
...
**Público principal**
- Idosos  
- Pessoas com deficiência visual, cognitiva ou motora  
- Adultos com baixo letramento digital  
- Pessoas que nunca utilizaram aplicativos financeiros  

**Público secundário**
- Familiares ou cuidadores  
- Pessoas que se sentem ansiosas ou confusas ao lidar com dinheiro  
...
## Evolução do MVP – Recuperação de Senha
...
## Conclusão
Este projeto demonstra que é possível transformar uma ideia em um conceito real de produto utilizando Inteligência Artificial, mesmo sem escrever código, apenas guiando a IA com intenção, contexto e criatividade.

O Vibe Coding se mostrou uma abordagem poderosa para explorar soluções inclusivas, acessíveis e centradas no usuário.
